...
const PRESS_ARTICLES: Article[] = [
  ...
  },
  {
    ...
    publisher: "Inc.",
    image:
      "https://img-cdn.inc.com/image/upload/f_webp,c_fit,w_828,q_auto/images/panoramic/walmart-discovered-roblox-inc_540292_jqbsla.jpg",
  ...
  },
  {
    ...
    image: "https://gamesbeat.com/wp-content/uploads/2025/05/Pop-Up-Shop-Group-On-Roblox.png",
  ...
  },
  {
    ...
    publisher: "Forbes",
    image:
      "https://imageio.forbes.com/specials-images/imageserve/624494b84e46e1925e31a3b8/A-series-of-events-related-to-The-Grammy-Awards-will-take-place-this-week-inside-of/1960x0.jpg?format=jpg&width=1440",
  ...
  },
  {
    ...
    image:
      "https://eu-images.contentstack.com/v3/assets/blt8770191dea35bccc/blt96205de11999c399/64d3ec31f2896830ac54855f/HotTopicRoblox10722.png?width=1280&auto=webp&quality=95&format=jpg&disable=upscale",
  ...
  return (
    <section id="press" className="py-24 bg-black-950 relative">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div
          className="absolute top-1/4 -left-[10%] w-[45%] h-[50%] rounded-full blur-[120px] bg-gold-500/5 animate-blob"
          style={{ animationDuration: "15s" }}
        ></div>
        <div
          className="absolute bottom-1/3 -right-[5%] w-[40%] h-[40%] rounded-full blur-[100px] bg-gold-500/5 animate-blob"
