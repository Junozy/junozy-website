      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <div>
                <label htmlFor="name" className="block text-sm font-medium text-gold-500 uppercase tracking-widest">
                  Name
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="email" className="block text-sm font-medium text-gold-500 uppercase tracking-widest">
                  Email
                </label>
                <input
                  type="email"
              ...
              <div>
                <label htmlFor="message" className="block text-sm font-medium text-gold-500 uppercase tracking-widest">
                  Message
                </label>
                <textarea
                  id="message"
