  ...
  return (
    <section id="featured-creations" className="py-24 bg-black-950 relative">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div
          className="absolute bottom-1/4 left-1/4 w-[30%] h-[40%] rounded-full blur-[120px] bg-gold-500/5 animate-float"
          style={{ animationDuration: "18s" }}
        ></div>
        <div
          className="absolute top-1/3 right-1/4 w-[25%] h-[35%] rounded-full blur-[100px] bg-gold-500/5 animate-float"
