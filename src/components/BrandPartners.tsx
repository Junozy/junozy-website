...
const PARTNERS: Partner[] = [
  ...
  },
  {
    id: 21,
    name: "NFL",
    image: "https://pbs.twimg.com/media/G0WBrLTawAAPfL9?format=jpg&name=medium",
  },
];
  ...
  return (
    <section id="brand-partners" className="py-24 bg-black-950 relative">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div
          className="absolute top-1/4 right-1/4 w-[45%] h-[50%] rounded-full blur-[120px] bg-gradient-to-br from-gold-500/15 to-gold-600/10 animate-blob"
          style={{ animationDuration: "20s" }}
        ></div>
        <div
          className="absolute bottom-1/3 left-1/4 w-[40%] h-[45%] rounded-full blur-[150px] bg-gradient-to-tl from-gold-400/8 to-gold-600/5 animate-blob"
