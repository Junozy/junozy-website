    ...
    <footer className="py-16 bg-black-950 relative">
      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-16">
          <div>
            <h3 className="text-2xl font-serif gold-text font-bold mb-6">JUNOZY</h3>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#collections" className="text-white/70 hover:text-gold-500 transition-colors">Collections</a>
              </li>
              <li>
                <a href="#about" className="text-white/70 hover:text-gold-500 transition-colors">About</a>
              </li>
              <li>
                <a href="#contact" className="text-white/70 hover:text-gold-500 transition-colors">Contact</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-white/70 mb-4">info@junozy.com</p>
