        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-16">
          <div className="object-fill">
            <a href="/" className="inline-block mb-6">
              <img alt="JUNOZY" src="/images/JunozyLogoText_NoLogo.png" className="h-12 px-[20px]" />
            </a>
            <p className="text-white/70 max-w-xs">Pushing the boundaries of digital fashion with a passion for bold ideas.</p>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://www.tiktok.com/@junozy_" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-gold-500 transition-colors" aria-label="TikTok">
